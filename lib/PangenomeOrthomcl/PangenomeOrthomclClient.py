...
class PangenomeOrthomcl(object):
    ...
    def build_pangenome_with_orthomcl(self, params, json_rpc_context = None):
        if json_rpc_context and type(json_rpc_context) is not dict:
            raise ValueError('Method build_pangenome_with_orthomcl: argument json_rpc_context is not type dict as required.')
        resp = self._call('PangenomeOrthomcl.build_pangenome_with_orthomcl',
