...
PangenomeOrthomclClient <- function(url, token = NULL, flatten = TRUE, 
    ...
    ret_client_object_ref[['build_pangenome_with_orthomcl']] <- function(params) {
        ret <- ret_client_object_ref[['json_rpc_call']]("PangenomeOrthomcl.build_pangenome_with_orthomcl", list(
                params
        ))
        return(ret[[1]])
    }
    ...
    class(ret_client_object_ref) <- 'PangenomeOrthomclClient'
