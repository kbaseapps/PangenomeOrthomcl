...
function PangenomeOrthomcl(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.build_pangenome_with_orthomcl = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "PangenomeOrthomcl.build_pangenome_with_orthomcl",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "PangenomeOrthomcl.status",
